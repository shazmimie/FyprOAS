  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 offset-md-4 form-wrapper auth login">
        ...
        <form action="Nlogin.php" method="post">
          <div class="form-group">
            <label>Username or Email</label>
            <input type="text" name="username" class="form-control form-control-lg" value="<?php echo $U_id; ?>">
          </div>
          <div class="form-group">
        ...
        <p>Don't yet have an account? <a href="Nsignup.php">Sign up</a></p>
      </div>
    </div>
  </div>
</body>

  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 offset-md-4 form-wrapper auth">
        ...
        <form action="Nsignup.php" method="post">
          <div class="form-group">
            <label>Username</label>
            <input type="text" name="U_id" class="form-control form-control-lg" value="<?php echo $U_id; ?>">
          </div>
          <div class="form-group">
            <label>Email</label>
        ...
        <p>Already have an account? <a href="Nlogin.php">Login</a></p>
      </div>
    </div>
  </div>
</body>

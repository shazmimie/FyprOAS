...
<tr>
  ...
  <?php
   //SQL query
    ...
    $sql = " SELECT student.U_name, student.U_id, student.S_category, application.A_title, application.L_name FROM student LEFT JOIN application ON student.U_id = application.U_id WHERE student.S_category ='FYP2'  ;"  or die(mysqli_connect_error());
...
?>
  ...
  <tr>
<form action="fyp2.php?U_id=<?php echo $U_id;?>" method="post">

...
<link rel="stylesheet" type="text/css" href="../style.css">
  ...
  <center>
     <br><br><br><br><br><br><br><br><br><h2>Student Profile</h2><br><br><br><br>
            <?php
              //$query = "SELECT * FROM requests LEFT JOIN lecturer ON requests.L_id = lecturer.L_id LEFT JOIN student ON student.U_id = requests.U_id where requests.U_id=student.U_id'";
               ...
               $query = "SELECT * FROM application LEFT JOIN student ON application.U_id = student.U_id LEFT JOIN lecturer ON application.L_id = lecturer.L_id  where application.U_id='$U_id' AND application.L_id='$a' ";
        ...
        <td><b><p class="lead text-muted">SUPERVISOR:  </b></td><td><?php echo $row['L_name'] ?></p></td></tr>
